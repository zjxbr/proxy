 ...
 *
 */
public class HttpClientRunLocalPost {
	public static void main(String[] args) throws InterruptedException {

		List<String> urList = new ArrayList<>();
		urList.add("http://www.amazon.co.jp/gp/aag/ajax/productWidget.html");
	...
	public static class HTTPRunnable implements Runnable {
		...
		public void run() {
			...
			method.setParameter("marketplaceID", "A1VC38T7YXB528");
			method.setParameter("useMYI", "1");
			method.setParameter("searchString", "");
			method.setParameter("seller", "A00651382GAGIIKDQPU6B");
